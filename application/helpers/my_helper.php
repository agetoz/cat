...
function tampil_media($file,$width="320px",$height="240px") {
	...
	$eks_image = array("jpeg","jpg","gif","bmp","png","JPEG","JPG","GIF","BMP","PNG");
...
function gen_menu() {
	...
	if ($sess_level == "guru") {
            ...
            array("icon"=>"file", "url"=>"h_ujian_guru", "text"=>"Hasil Ujian"),
            ...
            array("icon"=>"table", "url"=>"v_token", "text"=>"Daftar Token Ujian"),
            array("icon"=>"file", "url"=>"h_ujian_admin", "text"=>"Hasil Ujian"),
