<div class="panel panel-info">
    ...
    <div class="panel-body">
      <?php echo form_open_multipart(site_url()."/adm/m_soal/simpan", "class='form-horizontal'"); ?>
          ...
          <div id="konfirmasi"></div>
            ...
            <div class="form-group fgsoal">
              ...
              <div class="col-md-3">
                <input type="file" name="gambar_soal" id="gambar_soal" class="btn btn-info upload" style="width:230px;">
                <?php 
            ...
            <div class="form-group fgsoal">
              <div class="col-md-2"><label>Jawaban <?php echo strtoupper ($huruf_opsi[$j]); ?></label></div>
              <div class="col-md-3">
                <input type="file" name="gj<?php echo $huruf_opsi[$j]; ?>" id="gambar_soal" class="btn btn-success upload" style="width:230px;"><br>
                <?php 
            ...
            <div class="form-group" style="margin-top: 20px">
              <div class="col-md-12">
                ...
                <a href="<?php echo site_url(); ?>/adm/m_soal/pilih_mapel/<?php echo $d['id_mapel']; ?>" class="btn btn-default"><i class="fa fa-minus-circle"></i> Kembali</a>
              </div>
            </div>
      </form>
    </div><!-- panel body-->
